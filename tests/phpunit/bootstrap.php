...
define( 'LINKIFY_POSTS_PLUGIN_DIR',  dirname( __FILE__, 3 ) );
define( 'LINKIFY_POSTS_PLUGIN_FILE', LINKIFY_POSTS_PLUGIN_DIR . '/linkify-posts.php' );

$polyfill_path = LINKIFY_POSTS_PLUGIN_DIR . '/vendor/yoast/phpunit-polyfills/phpunitpolyfills-autoload.php';
...
function _manually_load_plugin() {
	require LINKIFY_POSTS_PLUGIN_FILE;
}
